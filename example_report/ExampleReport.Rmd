...
## Daily Kernel Density Estimation    
...
## Weekly Kernel Density Estimation

```{r, fig.height=9, fig.width=9}
x <- change_freq(fund, 'weeks')
viz_pdf(x, 13)
```

\newpage

## Monthly Kernel Density Estimation
...
## Large / Small and Value / Growth

Weekly Rolling Analysis

```{r}
viz_style_drift(fund, style_ind)
```
